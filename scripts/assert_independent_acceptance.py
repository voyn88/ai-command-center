...
# The policy -- what counts as an independent acceptance -- lives in
# `command_center.orchestrator.acceptance_policy` so that this gate and the
# GitHub App controller cannot drift apart on the same question
# (VOYN-W0-AICC-ACCEPTANCE-CONTROLLER-APP). This module keeps everything that
# talks to GitHub; the policy keeps everything that decides.
