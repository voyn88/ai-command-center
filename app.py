...
# The returned principal is deliberately not bound here: establishing *who* is
# at the console is not authorization, and a module-level name would invite a
# page to treat it as one. Anything privileged asks for itself, fresh, through
# `console_identity.require_console_operation`.
console_identity.require_identity(
