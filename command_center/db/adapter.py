...
What stays on this side of the seam is the domain: the migration-defined schema,
the `aicc_*` roles and grants, the repositories, the backup and restore policy,
and the composition that decides what "ready" means for this service. AIOS
knows none of those, and this module does not export anything that would let it
learn them.
