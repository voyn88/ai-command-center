...
DROP FUNCTION IF EXISTS backlog_dispatch_smoke();
DROP FUNCTION IF EXISTS backlog_set_task_class(text, text);
...
END
$$;
DROP FUNCTION IF EXISTS backlog_split_task(text, jsonb);
