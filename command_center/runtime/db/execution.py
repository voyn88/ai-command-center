...
def create_run(
    ...
    *,
    ...
    self-heals this by reconciling across the same grace window `reconcile()`
    itself enforces, then retrying on a same-host conflict — see its
    docstring). Real cross-host mutual exclusion needs a shared, host-aware
    lease authority outside this process's own SQLite file
